...
namespace DailyPlanner.Controllers
{
    ...
    {
        private DailyPlannerDbEntities db = new DailyPlannerDbEntities();
        ...
        public ActionResult Create([Bind(Include = "Id,Task,Status")] TaskList taskList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Task,Status")] TaskList taskList)
        {
            if (ModelState.IsValid)
            {
